...
private:
  ...
  mat sqrt_Q_;     ///< Process noise standard deviation
  mat sqrt_R_;     ///< Measurement noise standard deviation
  
  mat P_;          ///< Covariance matrix
  colvec x_m_;     ///< Estimated states
  colvec z_m_;     ///< Estimated outputs
